...
#include "AliAnalysisTaskNTGJTest.h"
...
ClassImp(AliAnalysisTaskNTGJTest);
...
AliAnalysisTaskNTGJTest::AliAnalysisTaskNTGJTest(const char *name)
    : AliAnalysisTaskEmcal(name), CLASS_INITIALIZATION
{
    DefineOutput(1, TTree::Class());
}

AliAnalysisTaskNTGJTest::AliAnalysisTaskNTGJTest(
    const AliAnalysisTaskNTGJTest & x)
...
AliAnalysisTaskNTGJTest & AliAnalysisTaskNTGJTest::operator=(
    const AliAnalysisTaskNTGJTest & x)
{
    if (this == &x) {
        return *this;
...
AliAnalysisTaskNTGJTest::~AliAnalysisTaskNTGJTest(void)
{
    if (_tree_event != NULL) {
        delete _tree_event;
    }
...
void AliAnalysisTaskNTGJTest::UserCreateOutputObjects(void)
{
...
Bool_t AliAnalysisTaskNTGJTest::Run()
{
...
void AliAnalysisTaskNTGJTest::loadEmcalGeometry()
{
    // lines 341-404
...
bool AliAnalysisTaskNTGJTest::getEvent(AliVEvent *&event,
...
void AliAnalysisTaskNTGJTest::getContainers(AliClusterContainer *&cluster_container,
                                        std::vector<AliTrackContainer*> &track_containers,
...
void AliAnalysisTaskNTGJTest::setTrackCuts()
{

}

void AliAnalysisTaskNTGJTest::getMultiplicityCentralityEventPlane(AliVEvent *event)
{
    // lines 547-604
...
void AliAnalysisTaskNTGJTest::loadPhotonNNModel()
{
    // lines 606-611
    if (_keras_model_photon_discrimination == NULL) {
...
void AliAnalysisTaskNTGJTest::loadMC(AliAODEvent *aod_event)
{
    // lines 616-683
...
void AliAnalysisTaskNTGJTest::getBeamProperties(AliVEvent *event,
        AliESDEvent *esd_event,
        AliAODEvent *aod_event,
...
void AliAnalysisTaskNTGJTest::getPrimaryVertex(AliVEvent *event,
        AliESDEvent *esd_event,
        const AliVVertex *&primary_vertex)
{
    // lines 692-717
...
void AliAnalysisTaskNTGJTest::getPrimaryVertexSPD(AliVEvent *event,
        AliESDEvent *esd_event,
        AliAODEvent *aod_event)
{
    // lines 719-745
...
void AliAnalysisTaskNTGJTest::getPileup(AliESDEvent *esd_event,
                                    AliAODEvent *aod_event)
{
...
bool AliAnalysisTaskNTGJTest::skimMultiplicityTracklet(AliVEvent *event)
{
    // lines 784-792
...
bool AliAnalysisTaskNTGJTest::skimClusterE(AliClusterContainer *cluster_container)
{
    // lines 811-829
...
void AliAnalysisTaskNTGJTest::getMetadata(AliESDEvent *esd_event,
                                      AliAODEvent *aod_event)
{
    ...
    if (!_metadata_filled) {
        ...
        // name
        strncpy(_branch_id_git, "$Id: d5b00448ced957333fdba14719970fc9fab824ac $", BUFSIZ);
...
// =================================================================================================================
void AliAnalysisTaskNTGJTest::getPrimaryMCParticles(AliMCParticleContainer *mc_container,
        std::vector<size_t> &stored_mc_truth_index,
        std::vector<Int_t> &reverse_stored_mc_truth_index,
        std::vector<Int_t> &reverse_stored_parton_algorithmic_index)
{
...
// =================================================================================================================
void AliAnalysisTaskNTGJTest::doTrackLoop(AliVEvent *event,
                                      AliAODEvent *aod_event,
                                      std::vector<AliTrackContainer*> track_containers,
                                      AliMCParticleContainer *mc_container,
                                      std::vector<size_t> stored_mc_truth_index,
...
// =================================================================================================================
void AliAnalysisTaskNTGJTest::doMCParticleLoop(AliMCParticleContainer *mc_container,
        AliESDEvent *esd_event,
        std::vector<Int_t> reverse_stored_mc_truth_index)
{
...
bool AliAnalysisTaskNTGJTest::getIsPromptPhoton(const AliAODMCParticle *finalParticle,
                                            AliMCParticleContainer *mc_container)
{
...
// =================================================================================================================
void AliAnalysisTaskNTGJTest::doClusterLoop(AliVEvent *event,
                                        AliVCaloCells *emcal_cell,
...
void AliAnalysisTaskNTGJTest::fillClusterBranches(AliVCaloCells *emcal_cell,
        AliVCluster *c,
        Int_t i,
        std::vector<size_t> stored_mc_truth_index)
{
...
void AliAnalysisTaskNTGJTest::fillPhotonNNBranches(AliVCluster *c,
        std::vector<size_t> stored_mc_truth_index,
        AliVCaloCells *emcal_cell,
        AliVVZERO *v0)
{
...
void AliAnalysisTaskNTGJTest::getUEJetsIsolation(AliESDEvent *esd_event,
        AliMCParticleContainer *mc_container,
        AliClusterContainer *cluster_container,
        std::vector<AliTrackContainer*> track_containers,
        std::vector<size_t> stored_mc_truth_index,
...
void AliAnalysisTaskNTGJTest::getTruthJetsAndIsolation(
    AliESDEvent *esd_event,
    AliMCParticleContainer *mc_container,
    AliClusterContainer *cluster_container,
    std::vector<size_t> stored_mc_truth_index,
...
void AliAnalysisTaskNTGJTest::getTruthJets(
    bool subtract_ue,
    AliMCParticleContainer *mc_container,
    std::vector<Int_t> reverse_stored_mc_truth_index,
    std::vector<fastjet::PseudoJet> &jet_truth_ak04,
...
void AliAnalysisTaskNTGJTest::getTruthIsolation(AliClusterContainer *cluster_container,
        AliMCParticleContainer *mc_container,
        bool subtract_ue,
        std::vector<size_t> stored_mc_truth_index)
{
...
void AliAnalysisTaskNTGJTest::getTpcUEJetsIsolation(
    std::vector<AliTrackContainer*> track_containers,
    AliClusterContainer *cluster_container,
    std::vector<bool> cell_pass_basic_quality,
    AliMCParticleContainer *mc_container,
...
void AliAnalysisTaskNTGJTest::getItsUEJetsIsolation(
    std::vector<AliTrackContainer*> track_containers,
    AliClusterContainer *cluster_container,
    std::vector<bool> cell_pass_basic_quality,
    AliMCParticleContainer *mc_container,
...
void AliAnalysisTaskNTGJTest::getClusterUEIsolation(
    AliClusterContainer *cluster_container,
    std::vector<bool> cell_pass_basic_quality)
{
    // initialize vectors
...
void AliAnalysisTaskNTGJTest::getVoronoiAreaTpc(
    std::vector<AliTrackContainer*> track_containers,
...
void AliAnalysisTaskNTGJTest::getVoronoiAreaIts(
    std::vector<AliTrackContainer*> track_containers,
...
void AliAnalysisTaskNTGJTest::getVoronoiAreaCluster(
    AliClusterContainer *cluster_container,
    std::vector<bool> cell_pass_basic_quality,
...
void AliAnalysisTaskNTGJTest::getUETpc(
    std::vector<fastjet::PseudoJet> particle_reco_tpc,
    std::vector<double> particle_reco_area_tpc,
...
void AliAnalysisTaskNTGJTest::getUEIts(
    std::vector<fastjet::PseudoJet> particle_reco_its,
    std::vector<double> particle_reco_area_its,
...
void AliAnalysisTaskNTGJTest::getUECluster(
    std::vector<fastjet::PseudoJet> particle_reco_cluster,
    std::vector<double> particle_reco_area_cluster,
...
void AliAnalysisTaskNTGJTest::getIsolationTpc(
    AliClusterContainer *cluster_container,
    std::vector<AliTrackContainer*> track_containers,
    std::map<size_t, size_t> track_reco_index_tpc,
    std::vector<double> particle_reco_area_tpc,
...
void AliAnalysisTaskNTGJTest::getIsolationIts(
    AliClusterContainer *cluster_container,
    std::vector<AliTrackContainer*> track_containers,
    std::map<size_t, size_t> track_reco_index_its,
    std::vector<double> particle_reco_area_its,
...
void AliAnalysisTaskNTGJTest::getIsolationCluster(
    AliClusterContainer *cluster_container,
    std::vector<bool> cell_pass_basic_quality,
    std::map<size_t, size_t> cluster_reco_index,
    std::vector<double> particle_reco_area_cluster,
...
void AliAnalysisTaskNTGJTest::getJetsTpc(
    std::vector<fastjet::PseudoJet> particle_reco_tpc,
...
void AliAnalysisTaskNTGJTest::getJetsIts(
    std::vector<fastjet::PseudoJet> particle_reco_its,
...
bool AliAnalysisTaskNTGJTest::skimJets()
{
    // lines 2335-2387
...
void AliAnalysisTaskNTGJTest::fillCellBranches(AliVCaloCells *emcal_cell,
        std::vector<size_t> stored_mc_truth_index)
{
...
void AliAnalysisTaskNTGJTest::fillMuonBranches()
{

}

void AliAnalysisTaskNTGJTest::fillEgNtrial()
{
    // lines 2512-2515
...
AliEMCALRecoUtils *AliAnalysisTaskNTGJTest::GetEMCALRecoUtils(void)
{
    return _reco_util;
}

void AliAnalysisTaskNTGJTest::SetAliROOTVersion(const char *version)
{
    strncpy(_branch_version_aliroot, version, BUFSIZ);
    _branch_version_aliroot[BUFSIZ - 1] = '\0';
}

void AliAnalysisTaskNTGJTest::SetAliPhysicsVersion(const char *version)
{
    strncpy(_branch_version_aliphysics, version, BUFSIZ);
    _branch_version_aliphysics[BUFSIZ - 1] = '\0';
}

void AliAnalysisTaskNTGJTest::SetGridDataDir(const char *dir)
{
    strncpy(_branch_grid_data_dir, dir, BUFSIZ);
    _branch_grid_data_dir[BUFSIZ - 1] = '\0';
}

void AliAnalysisTaskNTGJTest::SetGridDataPattern(const char *pattern)
{
    strncpy(_branch_grid_data_pattern, pattern, BUFSIZ);
    _branch_grid_data_pattern[BUFSIZ - 1] = '\0';
}

void AliAnalysisTaskNTGJTest::
...
void AliAnalysisTaskNTGJTest::SetSkimClusterMinE(double min_e)
{
    _skim_cluster_min_e = min_e;
}

void AliAnalysisTaskNTGJTest::SetSkimTrackMinPt(double min_pt)
{
    _skim_track_min_pt = min_pt;
}

void AliAnalysisTaskNTGJTest::SetSkimMuonTrackMinPt(double min_pt)
{
    _skim_muon_track_min_pt = min_pt;
}

void AliAnalysisTaskNTGJTest::SetSkimJetMinPt(double min_pt_1,
        double min_pt_2,
        double min_pt_3)
{
...
void AliAnalysisTaskNTGJTest::SetSkimJetAveragePt(double average_pt)
{
    _skim_jet_average_pt = average_pt;
}

void AliAnalysisTaskNTGJTest::SetSkimMultiplicityTrackletMinN(int min_n)
{
    _skim_multiplicity_tracklet_min_n = min_n;
}

void AliAnalysisTaskNTGJTest::SetStoredTrackMinPt(double min_pt)
{
...
void AliAnalysisTaskNTGJTest::SetStoredJetMinPtRaw(double min_pt_raw)
{
    _stored_jet_min_pt_raw = min_pt_raw;
}

void AliAnalysisTaskNTGJTest::SetNRandomIsolation(unsigned int nrandom_isolation)
{
    _nrandom_isolation = nrandom_isolation;
}

void AliAnalysisTaskNTGJTest::SetIsEmbed(bool is_embed)
{
    _is_embed = is_embed;
}
