...
class AliAnalysisTaskNTGJTest : public AliAnalysisTaskEmcal {
private:
...
public:
    AliAnalysisTaskNTGJTest(const char *name = "NTGJ");
    AliAnalysisTaskNTGJTest(const AliAnalysisTaskNTGJTest &);
    AliAnalysisTaskNTGJTest &operator=(const AliAnalysisTaskNTGJTest &);
    ~AliAnalysisTaskNTGJTest(void);
    ...
    ClassDef(AliAnalysisTaskNTGJTest, 1);
