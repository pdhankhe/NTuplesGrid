...
AddAliAnalysisTaskNTGJTest(TString name,
                       ...
                       TString embed_grid_file_pattern)
{
  ...
  AliAnalysisTaskNTGJTest *task =
    new AliAnalysisTaskNTGJTest(name.Data());

  // set to 2 to print number of clusters/tracks/MC particles
  // set to 3 to also print when entering various loops
  // AliLog::SetClassDebugLevel("AliAnalysisTaskNTGJTest", 2);
  ...
  filename += ":AliAnalysisTaskNTGJTest";
