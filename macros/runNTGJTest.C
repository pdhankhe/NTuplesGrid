...
void runNTGJTest(const char *config_filename = "config/15o.yaml",
             ...
             const char *local_file_list = "pbpb-filelist-18q.txt")
{
    ...
    gROOT->ProcessLine(".L AliAnalysisTaskNTGJTest.cxx+g");
    ...
    plugin->SetAdditionalLibs(
        "AliAnalysisTaskNTGJTest.h "
        "AliAnalysisTaskNTGJTest.cxx "
        "cgal_4_9.h " +
        oadb_filename + " " +
    ...
    plugin->SetAnalysisSource("AliAnalysisTaskNTGJTest.cxx");
    ...
    TString add_task_line = ".x macros/AddAliAnalysisTaskNTGJTest.C("
        "\"AliAnalysisTaskNTGJTest\",\"";
