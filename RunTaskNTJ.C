{   const char* launch = "local"; // local or grid
    ...
    alienHandler->SetAdditionalLibs("AliAnalysisTaskNTGJTest.cxx AliAnalysisTaskNTGJTest.h AddAliAnalysisTaskNTGJTest.C emcal_correction.yaml EMCALlocal2master.root geometry_2015.root libCDB.so libSTEER.so libGui.so libMinuit.so libXMLParser.so libRAWDatabase.so libRAWDatarec.so libSTEERBase.so "
                                            "cgal_4_9.h "
   ...
   // alienHandler->SetROOTVersion("v5-34-30-alice10-79");
    ...
    alienHandler->SetAliPhysicsVersion("vAN-20210311-1"); //Specify the version you want to use
   ...
   totruns += AddGoodRuns(alienHandler,"LHC15o_Gir",""); // specify LHC period
    ...
    gROOT->LoadMacro("AliAnalysisTaskNTGJTest.cxx++g");
    gROOT->LoadMacro("AddAliAnalysisTaskNTGJTest.C");
 ...
 /*   Bool_t isMC=false; // kTRUE in case of MC
    ...
    AddAliAnalysisTaskNTGJTest("ntuples","emcal_correction.yaml",true,false,false,false,"geometry_2015.root","EMCALlocal2master.root",false,15.0,-1.7976931348623157e+308,-1.7976931348623157e+308,-1.7976931348623157e+308,-1.7976931348623157e+308,-1.7976931348623157e+308,-1.7976931348623157e+308,-2147483648,-1.7976931348623157e+308,-1.7976931348623157e+308,0,"lhc15o",false,false,"","");
